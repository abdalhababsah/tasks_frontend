...
function ToBeAdded() {
  return (
    <MainLayout>
    <section className="p-4 md:ml-64 pt-10 bg-white h-screen flex items-center justify-center dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        <p className="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">
          Our team is working on track user perfomance, which will be added
          shortly. Stay tuned!
        </p>
        <NavLink to="/dashboard" replace={true}  className="font-light text-green-500 md:text-lg xl:text-xl dark:text-green-400">
          Back To Dashboard
        </NavLink>
      </div>
    </section>
